...
exports.ContactedField = exports.FieldWMatrix = void 0;
require("./field/semiconductor");
require("./field/metal");
...
class FieldWMatrix extends fields_1.Field {
}
exports.FieldWMatrix = FieldWMatrix;
// test in test/fields
class ContactedField extends FieldWMatrix {
        ...
        while (seeds.length > 0) {
            ...
            for (; d <= 1; d += d === 0 ? -1 : 2) {
                ...
                if (row) {
                    ...
                    for (; e < 2; e += 2) {
                        const cell = row[k + e];
                        if (cell && cell instanceof fields_1.Metal) { //} cell.BandGap==0) {
...
exports.ContactedField = ContactedField;
