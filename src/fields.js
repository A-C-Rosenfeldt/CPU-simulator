                ...
                if (typeof str[k].Contact === 'object') //  number means => simple test setup with given potential. Object means -> connected to wire with wave resistance
                 {
                    ...
                    let span = [-pitch, -1, str.length].map((global, l) => new enforcePivot_js_1.Span(3 - (Math.abs(1 - l) << 1), global + i_mat /* makes it square? */));
                    //const c = str[k]
                    ...
                    matrix.row[i_mat++] = new enforcePivot_js_1.Row(setCells); // push pull
                }
            }
            pitch = str.length;
            // with electrodes:
