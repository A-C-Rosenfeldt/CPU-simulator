...
exports.arenaVerbatim = exports.arena = exports.bandsGapped = exports.fieldTobeSquared = exports.exampleField = exports.Field = exports.FieldToDiagonal = exports.MapForField = exports.Metal = exports.Tupel = exports.Contact = exports.LinkIntoMatrix = void 0;
const enforcePivot_js_1 = require("./enforcePivot.js");
require("./field/semiconductor.js");
require("./field/metal.js");
/*
read from
...
var globalTime;
class LinkIntoMatrix {
}
exports.LinkIntoMatrix = LinkIntoMatrix;
class Contact extends LinkIntoMatrix {
}
exports.Contact = Contact;
class Tupel extends LinkIntoMatrix {
    constructor() {
        super(...arguments);
...
exports.MapForField = MapForField;
class FieldToDiagonal extends MapForField {
    ...
    ToDiagonalMatrix() {
        ...
        // 
        const matrix = new enforcePivot_js_1.Tridiagonal(this.flatLength); // number of rows. May need to grow, but no problem in sparse notation
        // flatten
        let p = 0;
        ...
        for (let i = 0; i < this.fieldInVarFloats.length; i++) {
            ...
            for (let k = 0; k < str.length; k++) {
                const c = str[k];
                matrix.row[p] = enforcePivot_js_1.Row.Single(p, c.BandGap); //new Row(a)//p, 0, [[], [ /* c.Potential // unsuited for testing*/], []])
                p++;
            }
        }
        return matrix;
    ...
    ShapeToSparseMatrix(metalLiesOutside = false) {
        const matrix = new enforcePivot_js_1.Tridiagonal(new Array()); // this failsthis.flatLength) // number of rows. May need to grow, but no problem in sparse notation
        const vector = []; // U vs u
            ...
            }
            {
                ...
                for (let k = 0; k < str.length; k++) { // second pass // JS is strange still. I need index:      for (let c of str) 
                    ...
                    if (typeof cell.RunningNumberOfJaggedArray !== 'undefined') { //  number means => simple test setup with given potential. Object means -> connected to wire with wave resistance
                        ...
                        matrix.row.push(new enforcePivot_js_1.Row(setCells)); // push pull  // Array is misused for  (pos|value)  pairs  and pos has to be ordered ( because this this removes ambigion in all my exisiting code .. uh, but see the ugly 3 lines above )
                    }
                }
            } // var
        } // for
...
exports.FieldToDiagonal = FieldToDiagonal;
class Field extends FieldToDiagonal {
    constructor() {
        super(...arguments);
