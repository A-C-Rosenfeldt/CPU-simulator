...
class DynamicContact extends fields_js_1.Contact {
    constructor() {
        super(...arguments);
        // static properties
    ...
    */
    Flow(voltageInSemi) {
        ...
        const a = new Array(3);
        a[0] = new enforcePivot_js_1.Span(0, 0);
        a[1] = (0, enforcePivot_js_1.FromRaw)(-1, +1); //R)
        a[2] = new enforcePivot_js_1.Span(0, 0);
        this.matrix.row.push(new enforcePivot_js_1.Row(a));
