import { Squeeze } from "./GL";

export function particle(canvasId: string, vertices: number[], extent: Squeeze) {
...

   {
...

      {
         ...
         squeeze[0] = 1 / extent.width // ugly  // todo: put just back in: //(data.length * (itemWidth+1) -1)  // gaps are 10%
